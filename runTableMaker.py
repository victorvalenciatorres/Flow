...
parser.add_argument("--add_extra_conv", help = "Add the new track etra converter", action = "store_true")
...
tables = {
  ...
  "MuonInfo" : {"table": "AOD/RTMUONINFO/0"}
}
...
muonCommonTables = ["ReducedMuons", "ReducedMuonsExtra", "MuonInfo"]
specificTables = {
  "processFull": [],
  ...
  "processMuonOnlyWithQvector": ["ReducedEventsQvector", "MuonInfo"],
